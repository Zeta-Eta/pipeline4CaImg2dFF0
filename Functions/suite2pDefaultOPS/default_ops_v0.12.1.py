def default():
    ...
    return {
        # Suite2p version
        'suite2p_version': '0.12.1', #current version of suite2p used for pipeline
        ...
        'splitThres': 1.25,  # EVafterSplit/EVb4Split
        ...
        'circular_neuropil': False, # otherwise the neuropil mask is a box
