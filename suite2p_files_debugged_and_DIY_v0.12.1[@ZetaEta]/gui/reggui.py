...
class BinaryPlayer(QMainWindow):
    ...
    def make_masks(self):
        ...
        for n in range(len(self.stat)):
            ...
            yext = self.stat[n]['yext']
            xext = self.stat[n]['xext']
            goodi = (yext>=0) & (xext>=0) & (yext<self.LY) & (xext<self.LX)
            self.stat[n]['yext4reggui'] = yext + 0.5
            self.stat[n]['xext4reggui'] = xext + 0.5
    ...
    def cell_mask(self):
        ...
        self.yext = self.stat[self.ichosen]['yext4reggui']
        self.xext = self.stat[self.ichosen]['xext4reggui']
