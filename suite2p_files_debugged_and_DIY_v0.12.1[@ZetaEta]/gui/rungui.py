...
class RunWindow(QDialog):
    ...
    def started(self):
        ...
        save_folder = os.path.join(self.db['save_path0'], self.ops['save_folder'])
    ...
    def finished(self):
        ...
        if self.finish and not self.error:
            ...
            if len(self.opslist)==1:
                self.parent.fname = os.path.join(self.db['save_path0'], self.ops['save_folder'], 'plane0','stat.npy')
